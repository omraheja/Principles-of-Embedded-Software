...
Project_Settings/Startup_Code/%.o: ../Project_Settings/Startup_Code/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -Wall  -g3 -x assembler-with-cpp -I"C:\Users\Isha Sawant\workspace.kds\uart_kl25z_pesproj2\INC" -I"C:\Users\Isha Sawant\workspace.kds\uart_kl25z_pesproj2\SRC" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
